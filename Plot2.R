...
##Reads the  "Individual household electric power consumption Data Set" available from the UC Irvine Machine Learning Repository, and produces a line graph of the Global Active Power consumption in kilowatts for the dates February 1 and 2, 2007. 
...
##6 The time column of df is reformated using the strptime function and using the format function to 
##7 plot is generated with df$Time on x-axis and global active power on y-axis. Default x-axis label is removed. Y-axis label is specified.
